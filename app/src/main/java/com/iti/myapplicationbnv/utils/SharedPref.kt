package com.iti.myapplicationbnv.utils
...
class SharedPref private constructor(private val sharedPreferences: SharedPreferences) {
    ...
    companion object {
        ...
        fun init(context: Context) {
            synchronized(this) {
                if (INSTANCE == null) {
                    val prefs = context.applicationContext.getSharedPreferences("user_data", Context.MODE_PRIVATE)
        ...
        fun getInstance(): SharedPref {
            return INSTANCE ?: throw IllegalStateException("SharedPref not initialized. Call SharedPref.init(context) in your Application class.")
        }
    }
